        ...
        <div class="row mb-3">
            <div class="col-md-8">
                <div class="input-group">
                    ...
                    <input id="avatarPath" class="form-control" type="text" name="avatar_path" value="{{old('avatar_path', $needle->avatar_path)}}" placeholder="Chọn hình đại diện cho bài viết">
                </div>
            </div>
            <div class="col-md-4">
